...
public class SRLHttpPipeline extends AbstractPipeline {
	...
	public SRLHttpPipeline(CompletePipeline pl, ImageCache imageCache, L l,
			int sentenceMaxLength, HttpOptions options) {
	...
	@Override
	public StringPair parseRequest(String inputSentence,
		...
		if (sentenceMaxLength > 0 && tokens.length > sentenceMaxLength)
			throw new SentenceTooLongException("Sentence too long",
					tokens.length);
	...
	public static void main(String[] args) throws ZipException, IOException,
		...
		CompletePipeline completePipeline = CompletePipeline
				.getCompletePipeline(options);
		HttpPipeline.setupHttpPipeline(options, new SRLHttpPipeline(
				completePipeline, HttpPipeline.imageCache, options.l,
				options.sentenceMaxLength, options));
