...
public class ParserStatusHandler extends AbstractHandler {
	...
	public void handle(HttpExchange exchange) throws IOException {
		...
		ret.append("server started ").append(
				dateformat.format(HttpPipeline.serverStart));
		ret.append('\n').append("Demo class: ")
				.append(pipeline.getClass().getCanonicalName());
		ret.append('\n').append("Sentence max length: ")
				.append(pipeline.sentenceMaxLength);
		ret.append("\n\n");
