...
public class WhatsWrongHelper {
	...
	public static ByteArrayOutputStream renderJPG(NLPInstance instance,
	...
	public static ByteArrayOutputStream renderPNG(NLPInstance instance,
			double scaleFactor) throws IOException {
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
	...
	public static NLPInstance getNLPInstance(Sentence s) {
		...
		NLPInstance instance = new NLPInstance(tokens, edges,
				NLPInstance.RenderType.single, Collections.EMPTY_LIST);
		return instance;
	}
	...
	public static void main(String[] args) throws IOException {
		SentenceReader reader = new AllCoNLL09Reader(
				new File(
						"/home/anders/corpora/conll09/eng/CoNLL2009-ST-English-trial.txt"));
