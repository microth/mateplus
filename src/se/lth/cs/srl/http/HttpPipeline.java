...
public class HttpPipeline {
	...
	public static final ImageCache imageCache = new ImageCache(1000 * 60 * 60,
			1000 * 60 * 60, 1000);

	private HttpPipeline(AbstractPipeline pipeline, HttpOptions options)
			throws IOException {
		...
		ParseRequestHandler parseHandler = new ParseRequestHandler(
				defaultHandler, pipeline);
	...
	public static void setupHttpPipeline(HttpOptions options,
		...
		try {
			...
			System.out
					.println("Caught exception while setting up server, exiting.");
