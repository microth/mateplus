...
public class ImageCache {
	...
	public synchronized int getSize() {
		...
		if (cacheSize != queueSize) {
			throw new Error("Cache and queue don't have equal size in "
					+ ImageCache.class.getName()
		...
		public void run() {
			while (alive) {
				while (!entryQueue.isEmpty()) {
					...
					if (first.earliestTimeOfDeath < System.currentTimeMillis()
							|| entryQueue.size() > maximumSize) {
