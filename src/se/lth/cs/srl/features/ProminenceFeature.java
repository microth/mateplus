...
public class ProminenceFeature extends AttrFeature {
	...
	protected ProminenceFeature(FeatureName name, WordData attr, TargetWord tw, String POSPrefix) {
	...
	private String makeFeatureString(Word arg) {
		...
		double prominence = 1.0-((CorpusSentence)arg.getMySentence()).averageChainSize();
