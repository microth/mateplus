...
public class FeatureGenerator implements Serializable {
    ...
    public Feature getFeature(FeatureName fn,boolean includeAllWords,String POSPrefix,BrownCluster bc, WordEmbedding we){
		...
		if(cache.containsKey(fn)){
			...
			case PredVoice:			ret=new PredDependentAttrFeature(fn,WordData.Voice,TargetWord.Pred,includeAllWords,POSPrefix); break;
			...
			case ArgVoice:			ret=new ArgDependentAttrFeature(fn,WordData.Voice,TargetWord.Arg,POSPrefix); break;
			
			case FirstWord:			ret=new ArgDependentAttrFeature(fn,WordData.Form,TargetWord.FirstWord,POSPrefix); break;
			case FirstLemma:		ret=new ArgDependentAttrFeature(fn,WordData.Lemma,TargetWord.FirstWord,POSPrefix); break;
			case FirstPOS:			ret=new ArgDependentAttrFeature(fn,WordData.POS,TargetWord.FirstWord,POSPrefix); break;
			case FirstDeprel:		ret=new ArgDependentAttrFeature(fn,WordData.Deprel,TargetWord.FirstWord,POSPrefix); break;

			case SecondWord:		ret=new ArgDependentAttrFeature(fn,WordData.Form,TargetWord.SecondWord,POSPrefix); break;
			case SecondLemma:		ret=new ArgDependentAttrFeature(fn,WordData.Lemma,TargetWord.SecondWord,POSPrefix); break;
			case SecondPOS:			ret=new ArgDependentAttrFeature(fn,WordData.POS,TargetWord.SecondWord,POSPrefix); break;
			case SecondDeprel:		ret=new ArgDependentAttrFeature(fn,WordData.Deprel,TargetWord.SecondWord,POSPrefix); break;
			
			case LastLemma:			ret=new ArgDependentAttrFeature(fn,WordData.Lemma,TargetWord.LastWord,POSPrefix); break;
			case LastPOS:			ret=new ArgDependentAttrFeature(fn,WordData.POS,TargetWord.LastWord,POSPrefix); break;
			case LastDeprel:		ret=new ArgDependentAttrFeature(fn,WordData.Deprel,TargetWord.LastWord,POSPrefix); break;

			case FirstCCWord:			ret=new ArgDependentAttrFeature(fn,WordData.ClosedClassForm,TargetWord.FirstWord,POSPrefix); break;
			case SecondCCWord:			ret=new ArgDependentAttrFeature(fn,WordData.ClosedClassForm,TargetWord.SecondWord,POSPrefix); break;
			case LastCCWord:			ret=new ArgDependentAttrFeature(fn,WordData.ClosedClassForm,TargetWord.LastWord,POSPrefix); break;

			
			case AnyLemma:			ret=new AnySetFeature(fn,WordData.Lemma,false,POSPrefix); break;
			case AnyPOS:			ret=new AnySetFeature(fn,WordData.POS,false,POSPrefix); break;
			...
			case DiscNew:			ret=new DiscNewFeature(POSPrefix); break;
			case XNCoref:				ret=new CorefFeature(false, POSPrefix); break;
			case FullCoref:				ret=new CorefFeature(true, POSPrefix); break;
			case CorefArgFeature:	ret=new CorefSetFeature(fn,null,false,true,includeAllWords,POSPrefix); break;
			case CorefPredFeature:  ret=new CorefSetFeature(fn,null,true,false,includeAllWords,POSPrefix); break;
			case CorefPredArgFeature:ret=new CorefSetFeature(fn,null,true,true,includeAllWords,POSPrefix); break;
			case DiscourseDistance: ret=new DiscourseDistanceFeature(fn, null, includeAllWords, POSPrefix); break;
			//case Salience:			ret=new SalienceFeature(fn,null,true,false,includeAllWords,POSPrefix); break;
			case Prominence:		ret=new ProminenceFeature(fn, null, TargetWord.Arg, POSPrefix); break;
			
			case DeprelDistance:	ret=new PathLengthFeature(fn, WordData.Deprel, true, POSPrefix); break;
			case SubCatSize:		ret=new SubCatSizeFeature(false, POSPrefix); break;
			case SpanSize:			ret=new SpanLengthFeature(fn, WordData.Deprel, false, POSPrefix); break;
		...
		if(f1 instanceof SingleFeature){
			...
			if(f2 instanceof SingleFeature){
				...
				if(f1 instanceof ChildSetFeature && f2 instanceof ChildSetFeature){
					...
					System.err.println("WARNING: Features "+f1.getName()+" and "+f2.getName()+" can not be combined. Skipping combination");
					return null;					
				}
			}
		}
