	...
	public String getCoreArgumentLabelSequence(Predicate pred, Map<Word, String> proposition) {
		...
		for(int i=1,size=sen.size();i<size;++i){
			...
			if(proposition.containsKey(word)){
				...
				if((Parse.parseOptions!=null && Parse.parseOptions.globalFeats && Parse.parseOptions.framenet) || 
						((Learn.learnOptions!=null && Learn.learnOptions.globalFeats && Learn.learnOptions.framenet)) ||
